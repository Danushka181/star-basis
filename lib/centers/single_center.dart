...
class SingleCenter extends StatefulWidget {
  ...
  @override
  State<SingleCenter> createState() {
    return _SingleCenterState();
  }
}

class _SingleCenterState extends State<SingleCenter> {
