...
class CommonCardCustomer extends StatelessWidget {
  ...
  const CommonCardCustomer({Key? key, required this.cardHeading, required this.idNumber, required this.cardSubHeading, required this.cardNumber, required this.createdBy, required this.createdDate}) : super(key: key);
