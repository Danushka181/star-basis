...
class CommonCardFiveSelect extends StatelessWidget {
  ...
  const CommonCardFiveSelect({Key? key, required this.cardHeading, required this.cardSubHeading, required this.loanAmount, required this.cardNumber, required this.createdAt, this.activeColor=Colors.white}) : super(key: key);
